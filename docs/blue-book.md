...
- After five: the scorecard, an exam-cover card with the date, class, subject, score, grade, the five books and an instructor's comment, plus Share, which copies three lines: `Blue Book #N · total / 5,000`, five tier emoji, the URL.
...
- A shareable image of the scorecard.
